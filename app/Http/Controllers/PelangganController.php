...
class PelangganController extends Controller
{
    ...
    {
        $rows = Pelanggan::with('cosmetic', 'user')->get();
    ...
    {
        $rowsUser = User::all();
        $rowCosmetic = Cosmetic::all();
        return view('pelanggan.create', compact('rowCosmetic', 'rowsUser'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $rowCairstyle = Cosmetic::findOrFail($row->pel_id_pro);
        return view('pelanggan.edit', compact('row', 'rowUser', 'rowCosmetic'));
    }
